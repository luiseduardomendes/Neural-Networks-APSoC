...
module ListBuffer_2(
  ...
  wire [43:0] _data_ext_R0_data;	// @[ListBuffer.scala:51:18]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        _RANDOM_1 = `RANDOM;
        valid = {_RANDOM_0, _RANDOM_1[3:0]};	// @[ListBuffer.scala:46:22]
        used = _RANDOM_1[31:4];	// @[ListBuffer.scala:46:22, :49:22]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_data_tag = _data_ext_R0_data[31:19];	// @[ListBuffer.scala:51:18]
  assign io_data_offset = _data_ext_R0_data[37:32];	// @[ListBuffer.scala:51:18]
  assign io_data_put = _data_ext_R0_data[43:38];	// @[ListBuffer.scala:51:18]
endmodule
