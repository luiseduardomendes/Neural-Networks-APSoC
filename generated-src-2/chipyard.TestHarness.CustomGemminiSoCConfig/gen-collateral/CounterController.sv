...
module CounterController(
  ...
  wire        _T_1 = ~out_valid_reg & io_in_valid;	// @[CounterFile.scala:232:32, :244:20, Decoupled.scala:51:35]
  wire        _T = io_out_ready & out_valid_reg;	// @[CounterFile.scala:232:32, Decoupled.scala:51:35]
  always @(posedge clock) begin
    if (_T | ~_T_1) begin	// @[CounterFile.scala:231:22, :253:24, :255:30, Decoupled.scala:51:35]
    end
    else begin	// @[CounterFile.scala:231:22, :253:24, :255:30]
      out_reg_rd <= io_in_bits_inst_rd;	// @[CounterFile.scala:231:22]
      out_reg_data <= _counterfile_io_data;	// @[CounterFile.scala:228:29, :231:22]
    end
    if (reset)
      out_valid_reg <= 1'h0;	// @[CounterFile.scala:232:32]
    else
      out_valid_reg <= ~_T & (_T_1 | out_valid_reg);	// @[CounterFile.scala:232:32, :253:24, :254:21, :255:30, :256:21, Decoupled.scala:51:35]
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _RANDOM_1 = `RANDOM;
        _RANDOM_2 = `RANDOM;
        out_reg_rd = _RANDOM_0[4:0];	// @[CounterFile.scala:231:22]
        out_reg_data = {_RANDOM_0[31:5], _RANDOM_1, _RANDOM_2[4:0]};	// @[CounterFile.scala:231:22]
        out_valid_reg = _RANDOM_2[5];	// @[CounterFile.scala:231:22, :232:32]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  CounterFile counterfile (	// @[CounterFile.scala:228:29]
    .clock                         (clock),
    .reset                         (reset),
    .io_counter_reset              (io_in_bits_rs1[0] & _T_1),	// @[CounterFile.scala:246:{51,55}, Decoupled.scala:51:35]
    .io_snapshot                   (io_in_bits_rs1[2] & _T_1),	// @[CounterFile.scala:248:{46,50}, Decoupled.scala:51:35]
    .io_snapshot_reset             (io_in_bits_rs1[1] & _T_1),	// @[CounterFile.scala:247:{52,56}, Decoupled.scala:51:35]
    .io_addr                       (io_in_bits_rs1[6:4]),	// @[CounterFile.scala:245:42]
    .io_config_address_valid       (io_in_bits_rs1[3] & _T_1),	// @[CounterFile.scala:249:{58,62}, Decoupled.scala:51:35]
    .io_config_address_bits        (io_in_bits_rs1[17:12]),	// @[CounterFile.scala:250:57]
    .io_external                   (io_in_bits_rs1[31]),	// @[CounterFile.scala:251:46]
  ...
  assign io_in_ready = ~out_valid_reg;	// @[CounterFile.scala:232:32, :244:20]
  assign io_out_valid = out_valid_reg;	// @[CounterFile.scala:232:32]
  assign io_out_bits_rd = out_reg_rd;	// @[CounterFile.scala:231:22]
  assign io_out_bits_data = out_reg_data;	// @[CounterFile.scala:231:22]
endmodule
