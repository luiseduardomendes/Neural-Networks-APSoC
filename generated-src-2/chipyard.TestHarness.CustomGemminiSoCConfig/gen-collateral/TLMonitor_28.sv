...
module TLMonitor_28(
  ...
  wire          _T_850 = _T_1004 & ~(|d_first_counter);	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:549:20]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _GEN_24 = _T_874 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire             _GEN_25 = _T_874 & ~same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    ...
    wire  [64:0]     _T_875 = inflight >> _GEN_23;	// @[Monitor.scala:611:27, :682:25]
    ...
    wire  [64:0]     _T_961 = 65'h0 >> _GEN_23;	// @[Monitor.scala:682:25, :723:35, :793:25]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~(_WIRE_2_3 & io_in_a_bits_size == 3'h6 & (&(io_in_a_bits_address[27:26])))) begin	// @[Monitor.scala:42:11, :81:{25,54}, :83:78, Parameters.scala:46:9, :91:48, :137:65]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~(_WIRE_2_3 & io_in_a_bits_size == 3'h6 & (&(io_in_a_bits_address[27:26])))) begin	// @[Monitor.scala:42:11, :81:25, :92:53, :94:78, Parameters.scala:46:9, :91:48, :137:65]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~((_source_ok_WIRE_0 | io_in_a_bits_source[6:4] == 3'h1 | ~(|(io_in_a_bits_source[6:4])) | _WIRE_2_3 | _source_ok_WIRE_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6) & io_in_a_bits_size != 3'h7 & (&(io_in_a_bits_address[27:26])))) begin	// @[Misc.scala:201:81, Monitor.scala:42:11, :92:25, :122:56, :123:74, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:65, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
