...
module SinkA(
  ...
  wire [40:0] freeOH = {~(_freeOH_T_15 | {_freeOH_T_15[7:0], 32'h0}), 1'h1} & {1'h0, _freeOH_T_22};	// @[Edges.scala:229:28, SinkA.scala:59:{16,25,33,39}, package.scala:245:{43,48,53}]
  ...
  wire        req_block = first & ~io_req_ready;	// @[Edges.scala:230:25, SinkA.scala:70:{25,28}]
  wire        buf_block = ~(io_a_bits_opcode[2]) & ~_putbuffer_io_push_ready;	// @[Edges.scala:91:{28,37}, SinkA.scala:51:25, :71:{27,30}]
  wire        set_block = ~(io_a_bits_opcode[2]) & first & (&lists);	// @[Edges.scala:91:{28,37}, :230:25, SinkA.scala:52:22, :58:21, :72:36]
  wire        _io_a_ready_output = ~req_block & ~buf_block & ~set_block;	// @[SinkA.scala:70:25, :71:27, :72:36, :78:{14,28,39,42}]
  wire        _T_3 = io_a_valid & first;	// @[Edges.scala:230:25, SinkA.scala:79:27]
  reg  [5:0]  put_r;	// @[Reg.scala:19:16]
  wire [5:0]  put = first ? freeIdx : put_r;	// @[Cat.scala:33:92, Edges.scala:230:25, Reg.scala:19:16, SinkA.scala:84:16]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      lists <= (lists | (_T_3 & ~(io_a_bits_opcode[2]) & ~req_block & ~buf_block ? freeOH[39:0] : 40'h0)) & ~(_T_9 & io_pb_pop_bits_last ? _lists_clr_T[39:0] : 40'h0);	// @[Decoupled.scala:51:35, Edges.scala:91:{28,37}, OneHot.scala:64:{12,27}, SinkA.scala:52:22, :54:27, :55:27, :56:{19,32,34}, :59:39, :70:25, :71:27, :78:{14,28}, :79:27, :81:{51,66,78}, :108:{24,48}, :109:15]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        first_counter = _RANDOM_1[9:8];	// @[Edges.scala:228:27, SinkA.scala:52:22]
  ...
  ListBuffer putbuffer (	// @[SinkA.scala:51:25]
    .clock                     (clock),
    .reset                     (reset),
    .io_push_valid             (io_a_valid & ~(io_a_bits_opcode[2]) & ~req_block & ~set_block),	// @[Edges.scala:91:{28,37}, SinkA.scala:70:25, :72:36, :78:{14,42}, :80:63]
  ...
  assign io_req_bits_tag = {io_a_bits_address[31], io_a_bits_address[27:16]};	// @[Parameters.scala:213:47, :214:22, :215:19]
