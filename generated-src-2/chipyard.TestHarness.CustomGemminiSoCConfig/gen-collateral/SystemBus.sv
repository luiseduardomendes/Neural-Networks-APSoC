...
module SystemBus(
  ...
  input  [127:0] auto_coupler_from_tile_tl_master_clock_xing_in_1_c_bits_data,
  ...
  input  [3:0]   auto_coupler_from_tile_tl_master_clock_xing_in_1_e_bits_sink,
  ...
  input  [4:0]   auto_coupler_from_tile_tl_master_clock_xing_in_0_a_bits_source,
  ...
  output [3:0]   auto_coupler_from_tile_tl_master_clock_xing_in_1_b_bits_size,
  ...
  output [4:0]   auto_coupler_from_tile_tl_master_clock_xing_in_0_d_bits_source,
  ...
  output [3:0]   auto_coupler_from_bus_named_subsystem_fbus_bus_xing_in_d_bits_sink,
  ...
  wire [3:0]   _fixer_auto_in_0_d_bits_sink;	// @[FIFOFixer.scala:145:27]
  ...
  wire [3:0]   _fixer_auto_out_2_a_bits_size;	// @[FIFOFixer.scala:145:27]
  wire [1:0]   _fixer_auto_out_2_a_bits_source;	// @[FIFOFixer.scala:145:27]
  wire [31:0]  _fixer_auto_out_2_a_bits_address;	// @[FIFOFixer.scala:145:27]
  wire [15:0]  _fixer_auto_out_2_a_bits_mask;	// @[FIFOFixer.scala:145:27]
  wire [127:0] _fixer_auto_out_2_a_bits_data;	// @[FIFOFixer.scala:145:27]
  wire         _fixer_auto_out_2_a_bits_corrupt;	// @[FIFOFixer.scala:145:27]
  wire         _fixer_auto_out_2_b_ready;	// @[FIFOFixer.scala:145:27]
  wire         _fixer_auto_out_2_c_valid;	// @[FIFOFixer.scala:145:27]
  wire [2:0]   _fixer_auto_out_2_c_bits_opcode;	// @[FIFOFixer.scala:145:27]
  wire [2:0]   _fixer_auto_out_2_c_bits_param;	// @[FIFOFixer.scala:145:27]
  wire [3:0]   _fixer_auto_out_2_c_bits_size;	// @[FIFOFixer.scala:145:27]
  wire [1:0]   _fixer_auto_out_2_c_bits_source;	// @[FIFOFixer.scala:145:27]
  wire [31:0]  _fixer_auto_out_2_c_bits_address;	// @[FIFOFixer.scala:145:27]
  wire [127:0] _fixer_auto_out_2_c_bits_data;	// @[FIFOFixer.scala:145:27]
  wire         _fixer_auto_out_2_c_bits_corrupt;	// @[FIFOFixer.scala:145:27]
  wire         _fixer_auto_out_2_d_ready;	// @[FIFOFixer.scala:145:27]
  wire         _fixer_auto_out_2_e_valid;	// @[FIFOFixer.scala:145:27]
  wire [3:0]   _fixer_auto_out_2_e_bits_sink;	// @[FIFOFixer.scala:145:27]
  ...
  TLXbar system_bus_xbar (	// @[SystemBus.scala:40:43]
    ...
    .auto_in_2_b_ready         (_fixer_auto_out_2_b_ready),	// @[FIFOFixer.scala:145:27]
    .auto_in_2_c_valid         (_fixer_auto_out_2_c_valid),	// @[FIFOFixer.scala:145:27]
    .auto_in_2_c_bits_opcode   (_fixer_auto_out_2_c_bits_opcode),	// @[FIFOFixer.scala:145:27]
    .auto_in_2_c_bits_param    (_fixer_auto_out_2_c_bits_param),	// @[FIFOFixer.scala:145:27]
    .auto_in_2_c_bits_size     (_fixer_auto_out_2_c_bits_size),	// @[FIFOFixer.scala:145:27]
    .auto_in_2_c_bits_source   (_fixer_auto_out_2_c_bits_source),	// @[FIFOFixer.scala:145:27]
    .auto_in_2_c_bits_address  (_fixer_auto_out_2_c_bits_address),	// @[FIFOFixer.scala:145:27]
    .auto_in_2_c_bits_data     (_fixer_auto_out_2_c_bits_data),	// @[FIFOFixer.scala:145:27]
    .auto_in_2_c_bits_corrupt  (_fixer_auto_out_2_c_bits_corrupt),	// @[FIFOFixer.scala:145:27]
    .auto_in_2_d_ready         (_fixer_auto_out_2_d_ready),	// @[FIFOFixer.scala:145:27]
    .auto_in_2_e_valid         (_fixer_auto_out_2_e_valid),	// @[FIFOFixer.scala:145:27]
    .auto_in_2_e_bits_sink     (_fixer_auto_out_2_e_bits_sink),	// @[FIFOFixer.scala:145:27]
  ...
  TLFIFOFixer fixer (	// @[FIFOFixer.scala:145:27]
    ...
    .auto_in_2_c_bits_opcode   (auto_coupler_from_tile_tl_master_clock_xing_in_1_c_bits_opcode),
    .auto_in_2_c_bits_param    (auto_coupler_from_tile_tl_master_clock_xing_in_1_c_bits_param),
    .auto_in_2_c_bits_size     (auto_coupler_from_tile_tl_master_clock_xing_in_1_c_bits_size),
    .auto_in_2_c_bits_source   (auto_coupler_from_tile_tl_master_clock_xing_in_1_c_bits_source),
    .auto_in_2_c_bits_address  (auto_coupler_from_tile_tl_master_clock_xing_in_1_c_bits_address),
    .auto_in_2_c_bits_data     (auto_coupler_from_tile_tl_master_clock_xing_in_1_c_bits_data),
    .auto_in_2_c_bits_corrupt  (auto_coupler_from_tile_tl_master_clock_xing_in_1_c_bits_corrupt),
    ...
    .auto_in_2_e_bits_sink     (auto_coupler_from_tile_tl_master_clock_xing_in_1_e_bits_sink),
    ...
    .auto_out_2_b_bits_size    (4'h6),	// @[SystemBus.scala:40:43]
    .auto_out_2_b_bits_source  (2'h0),	// @[SystemBus.scala:40:43]
    ...
    .auto_in_2_b_valid         (auto_coupler_from_tile_tl_master_clock_xing_in_1_b_valid),
    .auto_in_2_b_bits_param    (auto_coupler_from_tile_tl_master_clock_xing_in_1_b_bits_param),
    .auto_in_2_b_bits_size     (auto_coupler_from_tile_tl_master_clock_xing_in_1_b_bits_size),
    .auto_in_2_b_bits_source   (auto_coupler_from_tile_tl_master_clock_xing_in_1_b_bits_source),
    .auto_in_2_b_bits_address  (auto_coupler_from_tile_tl_master_clock_xing_in_1_b_bits_address),
    .auto_in_2_c_ready         (auto_coupler_from_tile_tl_master_clock_xing_in_1_c_ready),
