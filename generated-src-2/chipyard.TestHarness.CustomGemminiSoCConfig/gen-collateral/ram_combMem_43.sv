...
module ram_combMem_43(	// @[Decoupled.scala:273:95]
  ...
  reg [273:0] Memory[0:1];	// @[Decoupled.scala:273:95]
  ...
  `ifndef SYNTHESIS	// @[Decoupled.scala:273:95]
    `ifdef RANDOMIZE_MEM_INIT	// @[Decoupled.scala:273:95]
      ...
      reg [287:0] _RANDOM_MEM;	// @[Decoupled.scala:273:95]
    `endif // RANDOMIZE_MEM_INIT
    initial begin	// @[Decoupled.scala:273:95]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[Decoupled.scala:273:95]
        for (initvar = 0; initvar < 2; initvar = initvar + 1) begin
          _RANDOM_MEM = {{`RANDOM}, {`RANDOM}, {`RANDOM}, {`RANDOM}, {`RANDOM}, {`RANDOM}, {`RANDOM}, {`RANDOM}, {`RANDOM}};
          Memory[initvar] = _RANDOM_MEM[273:0];
        end	// @[Decoupled.scala:273:95]
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // not def SYNTHESIS
  assign R0_data = R0_en ? Memory[R0_addr] : 274'bx;	// @[Decoupled.scala:273:95]
endmodule
