...
module TLUART(
  ...
  wire [3:0][63:0] _GEN = {{{48'h0, div}}, {{30'h0, ip_rxwm, ip_txwm, 30'h0, ie_rxwm, ie_txwm}}, {{7'h0, rxwm, 15'h0, rxen, 7'h0, txwm, 14'h0, nstop, txen}}, {{~_rxq_io_deq_valid, 23'h0, _rxq_io_deq_bits, ~_txq_io_enq_ready, 31'h0}}};	// @[Bundles.scala:259:74, Cat.scala:33:92, MuxLiteral.scala:49:{10,48}, RegMapFIFO.scala:24:9, :45:21, RegisterRouter.scala:82:24, UART.scala:131:19, :134:19, :136:20, :142:21, :143:21, :150:21, :151:21, :152:22, :186:19, :189:28, :190:28]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (_out_wofireMux_T_2 & (&(auto_control_xing_in_a_bits_address[4:3])) & _out_out_bits_data_WIRE_3 & (&{{8{auto_control_xing_in_a_bits_mask[1]}}, {8{auto_control_xing_in_a_bits_mask[0]}}}))	// @[Bitwise.scala:28:17, :77:12, Cat.scala:33:92, RegisterRouter.scala:82:24]
        div <= auto_control_xing_in_a_bits_data[15:0];	// @[RegisterRouter.scala:82:24, UART.scala:136:20]
      if (out_woready_10 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, RegisterRouter.scala:82:24]
        txen <= auto_control_xing_in_a_bits_data[0];	// @[RegisterRouter.scala:82:24, UART.scala:142:21]
      if (out_woready_10 & auto_control_xing_in_a_bits_mask[4])	// @[Bitwise.scala:28:17, RegisterRouter.scala:82:24]
        rxen <= auto_control_xing_in_a_bits_data[32];	// @[RegisterRouter.scala:82:24, UART.scala:143:21]
      if (out_woready_10 & (&{auto_control_xing_in_a_bits_mask[3], {8{auto_control_xing_in_a_bits_mask[2]}}}))	// @[Bitwise.scala:28:17, :77:12, RegisterRouter.scala:82:24]
        txwm <= auto_control_xing_in_a_bits_data[24:16];	// @[RegisterRouter.scala:82:24, UART.scala:150:21]
      if (out_woready_10 & (&{auto_control_xing_in_a_bits_mask[7], {8{auto_control_xing_in_a_bits_mask[6]}}}))	// @[Bitwise.scala:28:17, :77:12, RegisterRouter.scala:82:24]
        rxwm <= auto_control_xing_in_a_bits_data[56:48];	// @[RegisterRouter.scala:82:24, UART.scala:151:21]
      if (out_woready_10 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, RegisterRouter.scala:82:24]
        nstop <= auto_control_xing_in_a_bits_data[1];	// @[RegisterRouter.scala:82:24, UART.scala:152:22]
      if (out_woready_12 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, RegisterRouter.scala:82:24]
        ie_rxwm <= auto_control_xing_in_a_bits_data[1];	// @[RegisterRouter.scala:82:24, UART.scala:186:19]
      if (out_woready_12 & auto_control_xing_in_a_bits_mask[0])	// @[Bitwise.scala:28:17, RegisterRouter.scala:82:24]
        ie_txwm <= auto_control_xing_in_a_bits_data[0];	// @[RegisterRouter.scala:82:24, UART.scala:186:19]
    end
  end // always @(posedge)
  `ifndef SYNTHESIS
  ...
  Queue_113 txq (	// @[UART.scala:131:19]
    .clock        (clock),
    .reset        (reset),
  ...
  Queue_113 rxq (	// @[UART.scala:134:19]
    .clock        (clock),
    .reset        (reset),
