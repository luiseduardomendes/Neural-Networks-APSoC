  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        saved_sink = _RANDOM_0[14:11];	// @[Repeater.scala:19:21, :20:18]
        saved_denied = _RANDOM_0[15];	// @[Repeater.scala:19:21, :20:18]
        saved_data = {_RANDOM_0[31:16], _RANDOM_1, _RANDOM_2, _RANDOM_3, _RANDOM_4[15:0]};	// @[Repeater.scala:19:21, :20:18]
        saved_corrupt = _RANDOM_4[16];	// @[Repeater.scala:20:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
