...
module TLXbar_5(
  ...
  reg  [8:0]  readys_mask;	// @[Arbiter.scala:24:23]
  wire [8:0]  _readys_filter_T_1 = readys_valid & ~readys_mask;	// @[Arbiter.scala:24:23, :25:{28,30}, Cat.scala:33:92]
  wire [7:0]  _GEN_2 = _readys_filter_T_1[7:0] | _readys_filter_T_1[8:1];	// @[Arbiter.scala:25:28, package.scala:254:43]
  wire        _GEN_3 = auto_out_8_d_valid | _readys_filter_T_1[0];	// @[Arbiter.scala:25:28, package.scala:254:43]
  ...
  wire        _GEN_9 = _GEN_2[6] | _readys_filter_T_1[8];	// @[Arbiter.scala:25:28, package.scala:254:43]
  ...
  wire        _GEN_15 = _GEN_10[4] | _readys_filter_T_1[8];	// @[Arbiter.scala:25:28, package.scala:254:43]
  ...
  wire        earlyWinner_8 = readys_readys[8] & auto_out_8_d_valid;	// @[Arbiter.scala:27:18, :96:86, :98:79]
  ...
  wire        out_30_valid = idle ? _sink_ACancel_earlyValid_T | auto_out_2_d_valid | auto_out_3_d_valid | auto_out_4_d_valid | auto_out_5_d_valid | auto_out_6_d_valid | auto_out_7_d_valid | auto_out_8_d_valid : state_0 & auto_out_0_d_valid | state_1 & auto_out_1_d_valid | state_2 & auto_out_2_d_valid | state_3 & auto_out_3_d_valid | state_4 & auto_out_4_d_valid | state_5 & auto_out_5_d_valid | state_6 & auto_out_6_d_valid | state_7 & auto_out_7_d_valid | state_8 & auto_out_8_d_valid;	// @[Arbiter.scala:89:28, :108:36, :117:26, :126:{29,56}, Mux.scala:27:73]
  wire        out_30_bits_corrupt = muxStateEarly_0 & auto_out_0_d_bits_corrupt | muxStateEarly_1 & auto_out_1_d_bits_corrupt | muxStateEarly_2 & auto_out_2_d_bits_corrupt | muxStateEarly_7 & auto_out_7_d_bits_corrupt | muxStateEarly_8 & auto_out_8_d_bits_corrupt;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  wire        out_30_bits_denied = muxStateEarly_0 & auto_out_0_d_bits_denied | muxStateEarly_1 & auto_out_1_d_bits_denied | muxStateEarly_2 & auto_out_2_d_bits_denied | muxStateEarly_7 & auto_out_7_d_bits_denied | muxStateEarly_8 & auto_out_8_d_bits_denied;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  wire        out_30_bits_sink = muxStateEarly_0 & auto_out_0_d_bits_sink | muxStateEarly_1 & auto_out_1_d_bits_sink | muxStateEarly_2 & auto_out_2_d_bits_sink | muxStateEarly_7 & auto_out_7_d_bits_sink | muxStateEarly_8 & auto_out_8_d_bits_sink;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  wire [6:0]  out_30_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 7'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 7'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_source : 7'h0) | (muxStateEarly_3 ? auto_out_3_d_bits_source : 7'h0) | (muxStateEarly_4 ? auto_out_4_d_bits_source : 7'h0) | (muxStateEarly_5 ? auto_out_5_d_bits_source : 7'h0) | (muxStateEarly_6 ? auto_out_6_d_bits_source : 7'h0) | (muxStateEarly_7 ? auto_out_7_d_bits_source : 7'h0) | (muxStateEarly_8 ? auto_out_8_d_bits_source : 7'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  wire [3:0]  out_30_bits_size = (muxStateEarly_0 ? auto_out_0_d_bits_size : 4'h0) | (muxStateEarly_1 ? {1'h0, auto_out_1_d_bits_size} : 4'h0) | (muxStateEarly_2 ? {1'h0, auto_out_2_d_bits_size} : 4'h0) | (muxStateEarly_3 ? {1'h0, auto_out_3_d_bits_size} : 4'h0) | (muxStateEarly_4 ? {1'h0, auto_out_4_d_bits_size} : 4'h0) | (muxStateEarly_5 ? {1'h0, auto_out_5_d_bits_size} : 4'h0) | (muxStateEarly_6 ? {1'h0, auto_out_6_d_bits_size} : 4'h0) | (muxStateEarly_7 ? {1'h0, auto_out_7_d_bits_size} : 4'h0) | (muxStateEarly_8 ? {1'h0, auto_out_8_d_bits_size} : 4'h0);	// @[Arbiter.scala:118:30, BundleMap.scala:247:19, Bundles.scala:259:74, Mux.scala:27:73]
  wire [1:0]  out_30_bits_param = (muxStateEarly_0 ? auto_out_0_d_bits_param : 2'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_param : 2'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_param : 2'h0) | (muxStateEarly_7 ? auto_out_7_d_bits_param : 2'h0) | (muxStateEarly_8 ? auto_out_8_d_bits_param : 2'h0);	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  wire [2:0]  out_30_bits_opcode = (muxStateEarly_0 ? auto_out_0_d_bits_opcode : 3'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_opcode : 3'h0) | (muxStateEarly_2 ? auto_out_2_d_bits_opcode : 3'h0) | (muxStateEarly_3 ? auto_out_3_d_bits_opcode : 3'h0) | (muxStateEarly_4 ? auto_out_4_d_bits_opcode : 3'h0) | (muxStateEarly_5 ? auto_out_5_d_bits_opcode : 3'h0) | {2'h0, muxStateEarly_6} | (muxStateEarly_7 ? auto_out_7_d_bits_opcode : 3'h0) | (muxStateEarly_8 ? auto_out_8_d_bits_opcode : 3'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  wire [8:0]  _readys_mask_T = readys_readys & readys_valid;	// @[Arbiter.scala:27:18, :29:29, Cat.scala:33:92]
  wire [8:0]  _readys_mask_T_3 = _readys_mask_T | {_readys_mask_T[7:0], 1'h0};	// @[Arbiter.scala:29:29, package.scala:245:{43,53}]
  ...
  wire        winnerQual_8 = readys_readys[8] & auto_out_8_d_valid;	// @[Arbiter.scala:27:18, :96:86, :99:79]
  always @(posedge clock) begin
    if (reset) begin
      beatsLeft <= 9'h0;	// @[Arbiter.scala:88:30, Edges.scala:220:14]
      readys_mask <= 9'h1FF;	// @[Arbiter.scala:24:23]
  ...
  `ifndef SYNTHESIS
    ...
    wire         _T_68 = auto_out_0_d_valid | auto_out_1_d_valid;	// @[Arbiter.scala:109:36]
    always @(posedge clock) begin	// @[Arbiter.scala:106:13]
      if (~reset & ~((~earlyWinner_0 | ~earlyWinner_1) & (~prefixOR_2 | ~earlyWinner_2) & (~prefixOR_3 | ~earlyWinner_3) & (~prefixOR_4 | ~earlyWinner_4) & (~prefixOR_5 | ~earlyWinner_5) & (~prefixOR_6 | ~earlyWinner_6) & (~prefixOR_7 | ~earlyWinner_7) & (~(prefixOR_7 | earlyWinner_7) | ~earlyWinner_8))) begin	// @[Arbiter.scala:98:79, :105:53, :106:{13,61,64,67,82}]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        readys_mask = _RANDOM_0[17:9];	// @[Arbiter.scala:24:23, :88:30]
        ...
        state_8 = _RANDOM_0[26];	// @[Arbiter.scala:88:30, :117:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_in_d_valid = out_30_valid;	// @[Arbiter.scala:126:29]
  ...
  assign auto_out_8_d_ready = auto_in_d_ready & (idle ? readys_readys[8] : state_8);	// @[Arbiter.scala:27:18, :89:28, :96:86, :117:26, :122:24, :124:31]
