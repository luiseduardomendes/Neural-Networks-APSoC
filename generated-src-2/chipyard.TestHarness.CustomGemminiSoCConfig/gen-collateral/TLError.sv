...
module TLError(
  ...
  wire            _a_io_deq_ready_T_3 = auto_in_d_ready & (counter == 9'h1 | (da_bits_opcode[0] ? ~(_beats1_decode_T_1[11:3]) : 9'h0) == 9'h0) | ~a_last;	// @[Edges.scala:105:36, :220:14, :228:27, :231:{25,37,47}, Error.scala:32:{26,46,49}, :35:21, package.scala:235:{46,71,76}]
  wire            da_valid = _a_io_deq_valid & a_last;	// @[Decoupled.scala:375:21, Edges.scala:231:37, Error.scala:33:25]
    ...
    if (reset) begin
      ...
      if (auto_in_d_ready & da_valid) begin	// @[Decoupled.scala:51:35, Error.scala:33:25]
        if (counter == 9'h0) begin	// @[Edges.scala:228:27, :230:25]
          if (da_bits_opcode[0])	// @[Edges.scala:105:36, Error.scala:35:21]
  ...
  TLMonitor_24 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_d_bits_corrupt (da_bits_opcode[0])	// @[Edges.scala:105:36, Error.scala:35:21]
  );
  ...
  assign auto_in_d_bits_corrupt = da_bits_opcode[0];	// @[Edges.scala:105:36, Error.scala:35:21]
endmodule
