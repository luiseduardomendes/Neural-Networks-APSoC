...
module DMACommandTracker_1(
  ...
  input  [14:0] io_alloc_bits_bytes_to_read,
  ...
  reg  [14:0] cmds_0_bytes_left;	// @[DMACommandTracker.scala:61:17]
  reg         cmds_1_valid;	// @[DMACommandTracker.scala:61:17]
  reg  [5:0]  cmds_1_tag_rob_id;	// @[DMACommandTracker.scala:61:17]
  reg  [14:0] cmds_1_bytes_left;	// @[DMACommandTracker.scala:61:17]
  ...
  wire        _io_cmd_completed_valid_T = cmds_0_bytes_left == 15'h0;	// @[DMACommandTracker.scala:61:17, :72:34]
  wire        _io_cmd_completed_valid_T_2 = cmds_1_bytes_left == 15'h0;	// @[DMACommandTracker.scala:61:17, :72:34]
  ...
  wire [14:0] _GEN_0 = io_request_returned_bits_cmd_id ? cmds_1_bytes_left : cmds_0_bytes_left;	// @[DMACommandTracker.scala:61:17, :86:56]
  ...
  wire [14:0] _cmds_bytes_left_T_1 = _GEN_0 - 15'h1;	// @[DMACommandTracker.scala:86:56]
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[DMACommandTracker.scala:88:11]
      ...
      if (io_request_returned_valid & ~reset & _GEN_0 == 15'h0) begin	// @[DMACommandTracker.scala:72:34, :86:56, :89:{11,36}]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        cmds_0_bytes_left = _RANDOM_0[21:7];	// @[DMACommandTracker.scala:61:17]
        cmds_1_valid = _RANDOM_0[22];	// @[DMACommandTracker.scala:61:17]
        cmds_1_tag_rob_id = _RANDOM_0[28:23];	// @[DMACommandTracker.scala:61:17]
        cmds_1_bytes_left = {_RANDOM_0[31:29], _RANDOM_1[11:0]};	// @[DMACommandTracker.scala:61:17]
      `endif // RANDOMIZE_REG_INIT
    end // initial
