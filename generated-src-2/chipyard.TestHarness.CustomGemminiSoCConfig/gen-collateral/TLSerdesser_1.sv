...
module TLSerdesser_1(
  ...
  wire        _inDes_io_out_ready_T = _inDes_io_out_bits_chanId == 3'h0;	// @[Bundles.scala:260:74, Serdes.scala:234:37, :644:23]
  ...
  TLMonitor_71 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_d_bits_sink    (_inDes_io_out_bits_union[4:1]),	// @[Serdes.scala:465:17, :644:23]
  ...
  HellaPeekingArbiter_TestHarness_UNIQUIFIED outArb (	// @[Serdes.scala:637:24]
    .clock                (clock),
    .reset                (reset),
    ...
    .io_in_1_bits_source  ({4'h0, auto_client_out_d_bits_source}),	// @[Serdes.scala:314:20]
    ...
    .io_in_4_bits_size    ({4'h0, auto_manager_in_a_bits_size}),	// @[Serdes.scala:256:20, :314:20]
  ...
  GenericSerializer_TestHarness_UNIQUIFIED outSer (	// @[Serdes.scala:639:24]
    .clock              (clock),
    .reset              (reset),
  ...
  GenericDeserializer_TestHarness_UNIQUIFIED inDes (	// @[Serdes.scala:644:23]
    .clock               (clock),
    .reset               (reset),
    .io_in_valid         (io_ser_in_valid),
    .io_in_bits          (io_ser_in_bits),
    .io_out_ready        (_inDes_io_out_bits_chanId != 3'h4 & (_inDes_io_out_ready_T_6 ? auto_manager_in_d_ready : ~(_inDes_io_out_bits_chanId == 3'h2 | _inDes_io_out_bits_chanId == 3'h1) & _inDes_io_out_ready_T & auto_client_out_a_ready)),	// @[Edges.scala:231:25, Mux.scala:81:58, Serdes.scala:234:37, :235:37, :236:37, :237:37, :238:37, :331:20, :644:23]
  ...
  assign auto_manager_in_d_bits_sink = _inDes_io_out_bits_union[4:1];	// @[Serdes.scala:465:17, :644:23]
  ...
  assign auto_client_out_a_bits_source = _inDes_io_out_bits_source[3:0];	// @[Serdes.scala:375:15, :644:23]
