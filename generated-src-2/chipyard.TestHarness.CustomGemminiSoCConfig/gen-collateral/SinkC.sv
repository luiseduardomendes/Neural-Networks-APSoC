...
module SinkC(
  ...
  wire [12:0]  tag = {_c_io_deq_bits_address[31], _c_io_deq_bits_address[27:16]};	// @[Decoupled.scala:375:21, Parameters.scala:213:47, :214:22, :215:19]
  ...
  wire         bs_adr_valid = resp & ((|counter) | _c_io_deq_valid & _c_io_deq_bits_opcode[0]);	// @[Decoupled.scala:375:21, Edges.scala:101:36, :228:27, :230:25, SinkC.scala:79:19, :99:{30,41,53}]
  ...
  wire [1:0]   _GEN = {~(_freeOH_T_7[0]), 1'h1} & _freeOH_T_7;	// @[Edges.scala:229:28, SinkC.scala:123:{18,27,35,41}]
  wire [1:0]   freeIdx = {1'h0, _GEN[1]};	// @[Cat.scala:33:92, CircuitMath.scala:28:8, Edges.scala:229:28, SinkC.scala:123:41]
  wire         req_block = ~(|counter) & ~io_req_ready;	// @[Edges.scala:228:27, :230:25, SinkC.scala:126:{27,30}]
  wire         buf_block = _c_io_deq_bits_opcode[0] & ~_putbuffer_io_push_ready;	// @[Decoupled.scala:375:21, Edges.scala:101:36, SinkC.scala:115:27, :127:{29,32}]
  wire         set_block = _c_io_deq_bits_opcode[0] & ~(|counter) & (&lists);	// @[Decoupled.scala:375:21, Edges.scala:101:36, :228:27, :230:25, SinkC.scala:116:24, :122:23, :128:38]
  wire         _c_io_deq_ready_T_7 = raw_resp ? ~(_c_io_deq_bits_opcode[0]) | _io_bs_adr_q_io_enq_ready : ~req_block & ~buf_block & ~set_block;	// @[Decoupled.scala:375:21, Edges.scala:101:36, SinkC.scala:78:58, :107:61, :126:27, :127:29, :128:38, :134:{19,39,56,70,81,84}]
  reg  [1:0]   put_r;	// @[Reg.scala:19:16]
  wire [1:0]   put = (|counter) ? put_r : freeIdx;	// @[Cat.scala:33:92, Edges.scala:228:27, :230:25, Reg.scala:19:16, SinkC.scala:140:18]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      lists <= 2'h0;	// @[Edges.scala:228:27, SinkC.scala:116:24]
    end
    else begin
    ...
    if (_c_io_deq_valid) begin	// @[Decoupled.scala:375:21]
      ...
      bs_adr_bits_beat_r <= beat + {1'h0, _io_bs_adr_q_io_enq_ready};	// @[Decoupled.scala:375:21, Edges.scala:229:28, :233:25, Reg.scala:19:16, SinkC.scala:103:59]
    end
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        lists = _RANDOM_4[16:15];	// @[Reg.scala:19:16, SinkC.scala:116:24]
  ...
  Queue_59 c (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
  ...
  Queue_60 io_bs_adr_q (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
    ...
    .io_enq_bits_beat (_c_io_deq_valid ? beat : bs_adr_bits_beat_r),	// @[Decoupled.scala:375:21, Edges.scala:233:25, Reg.scala:19:16, SinkC.scala:103:28]
  ...
  ListBuffer_1 putbuffer (	// @[SinkC.scala:115:27]
    .clock                     (clock),
    .reset                     (reset),
    .io_push_valid             (~resp & _c_io_deq_valid & _c_io_deq_bits_opcode[0] & ~req_block & ~set_block),	// @[Decoupled.scala:375:21, Edges.scala:101:36, SinkC.scala:79:19, :126:27, :128:38, :134:{56,84}, :136:21, :137:74]
  ...
  assign io_req_valid = ~resp & _c_io_deq_valid & ~(|counter) & ~buf_block & ~set_block;	// @[Decoupled.scala:375:21, Edges.scala:228:27, :230:25, SinkC.scala:79:19, :127:29, :128:38, :134:{70,84}, :136:{21,61}]
  ...
  assign io_req_bits_tag = tag;	// @[Parameters.scala:214:22, :215:19]
  ...
  assign io_resp_valid = resp & _c_io_deq_valid & (~(|counter) | last) & (~(_c_io_deq_bits_opcode[0]) | _io_bs_adr_q_io_enq_ready);	// @[Decoupled.scala:375:21, Edges.scala:101:36, :228:27, :230:25, :231:37, SinkC.scala:79:19, :107:{48,57,61,70}]
  ...
  assign io_resp_bits_tag = tag;	// @[Parameters.scala:214:22, :215:19]
