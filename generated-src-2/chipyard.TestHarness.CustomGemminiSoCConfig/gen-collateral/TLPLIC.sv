...
module TLPLIC(
  ...
  wire        claimedDevs_1 = claimer_0 & maxDevs_0 | claimer_1 & maxDevs_1;	// @[Plic.scala:181:22, :246:{49,92}, RegisterRouter.scala:82:24]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        pending_0 = _RANDOM_0[3];	// @[Plic.scala:163:31, :168:26]
        ...
        x1_0_REG = _RANDOM_0[8];	// @[Plic.scala:163:31, :188:45]
        bundleOut_1_0_REG = _RANDOM_0[9];	// @[Plic.scala:163:31, :188:45]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_110 out_back (	// @[Decoupled.scala:375:21]
    .clock                               (clock),
    .reset                               (reset),
