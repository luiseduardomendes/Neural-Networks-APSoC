...
module TLXbar_10(
  ...
  wire        out_7_valid = auto_out_d_valid & auto_out_d_bits_source[4];	// @[Parameters.scala:54:10, Xbar.scala:182:40]
  wire        out_10_valid = auto_out_d_valid & ~(auto_out_d_bits_source[4]);	// @[Parameters.scala:54:{10,32}, Xbar.scala:182:40]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (latch)	// @[Arbiter.scala:90:24]
        beatsLeft <= (winnerQual_0 & ~(auto_in_0_a_bits_opcode[2]) ? ~(_beatsAI_decode_T_1[11:4]) : 8'h0) | (winnerQual_1 & ~(auto_in_1_a_bits_opcode[2]) ? ~(_beatsAI_decode_T_5[11:4]) : 8'h0);	// @[Arbiter.scala:88:30, :99:79, :112:73, :113:44, Edges.scala:91:{28,37}, :220:14, package.scala:235:{46,71,76}]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        readys_mask = _RANDOM_0[9:8];	// @[Arbiter.scala:24:23, :88:30]
        state_0 = _RANDOM_0[10];	// @[Arbiter.scala:88:30, :117:26]
        state_1 = _RANDOM_0[11];	// @[Arbiter.scala:88:30, :117:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_out_a_bits_mask = (muxStateEarly_0 ? auto_in_0_a_bits_mask : 16'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_mask : 16'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_data = (muxStateEarly_0 ? auto_in_0_a_bits_data : 128'h0) | (muxStateEarly_1 ? auto_in_1_a_bits_data : 128'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
