...
module TLCacheCork(
  ...
  wire        bundleIn_0_a_ready = toD ? _q_1_io_enq_ready : out_1_ready;	// @[Arbiter.scala:124:31, CacheCork.scala:68:97, :70:26, Decoupled.scala:375:21]
  ...
  wire        bundleIn_0_c_ready = _bundleIn_0_c_ready_T ? _q_io_enq_ready : out_ready;	// @[Arbiter.scala:124:31, CacheCork.scala:104:53, :108:26, Decoupled.scala:375:21]
  reg  [2:0]  d_first_counter;	// @[Edges.scala:228:27]
  wire        d_grant = out_6_bits_opcode == 3'h5 | out_6_bits_opcode == 3'h4;	// @[CacheCork.scala:78:27, :124:{40,54,74}, Mux.scala:27:73]
  assign bundleIn_0_d_valid = out_6_valid & (_pool_io_alloc_valid | (|d_first_counter) | ~d_grant);	// @[Arbiter.scala:126:29, CacheCork.scala:118:26, :124:54, :126:{34,70,73}, Edges.scala:228:27, :230:25]
  ...
  wire        earlyWinner_1 = ~winnerQual_0 & out_1_earlyValid;	// @[Arbiter.scala:17:61, :98:79, CacheCork.scala:72:33, :93:33]
  wire        _sink_ACancel_earlyValid_T = winnerQual_0 | out_1_earlyValid;	// @[Arbiter.scala:108:36, CacheCork.scala:72:33, :93:33]
  reg         state_0;	// @[Arbiter.scala:117:26]
  reg         state_1;	// @[Arbiter.scala:117:26]
  wire        muxStateEarly_0 = idle ? winnerQual_0 : state_0;	// @[Arbiter.scala:89:28, :117:26, :118:30, CacheCork.scala:93:33]
  ...
  assign out_1_ready = auto_out_a_ready & (idle ? ~winnerQual_0 : state_1);	// @[Arbiter.scala:17:61, :89:28, :117:26, :122:24, :124:31, CacheCork.scala:93:33]
  wire        out_2_valid = idle ? _sink_ACancel_earlyValid_T : state_0 & winnerQual_0 | state_1 & out_1_earlyValid;	// @[Arbiter.scala:89:28, :108:36, :117:26, :126:29, CacheCork.scala:72:33, :93:33, Mux.scala:27:73]
  ...
  wire [3:0]  out_6_bits_source = (muxStateEarly_1_0 ? auto_out_d_bits_source[4:1] : 4'h0) | (muxStateEarly_1_1 ? _q_io_deq_bits_source : 4'h0) | (muxStateEarly_1_2 ? _q_1_io_deq_bits_source : 4'h0);	// @[Arbiter.scala:118:30, CacheCork.scala:134:46, Decoupled.scala:375:21, Mux.scala:27:73, Nodes.scala:1215:84]
  ...
  wire [1:0]  out_6_bits_param = (muxStateEarly_1_0 ? (_T_18 ? {1'h0, ~((|d_first_counter) ? dWHeld_r : _GEN_0)} : auto_out_d_bits_param) : 2'h0) | (muxStateEarly_1_1 ? _q_io_deq_bits_param : 2'h0) | (muxStateEarly_1_2 ? _q_1_io_deq_bits_param : 2'h0);	// @[Arbiter.scala:118:30, CacheCork.scala:133:13, :142:25, :153:{51,76}, :155:{26,32}, Decoupled.scala:375:21, Edges.scala:228:27, :230:25, Mux.scala:27:73, Nodes.scala:1215:84, Reg.scala:19:16, package.scala:80:42]
  assign out_6_bits_opcode = (muxStateEarly_1_0 ? out_3_bits_opcode : 3'h0) | (muxStateEarly_1_1 ? _q_io_deq_bits_opcode : 3'h0) | (muxStateEarly_1_2 ? _q_1_io_deq_bits_opcode : 3'h0);	// @[Arbiter.scala:118:30, CacheCork.scala:153:76, :157:73, :158:27, Decoupled.scala:375:21, Mux.scala:27:73, Nodes.scala:1215:84]
  ...
  wire        winnerQual_1 = ~winnerQual_0 & out_1_earlyValid;	// @[Arbiter.scala:17:61, :99:79, CacheCork.scala:72:33, :93:33]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (out_6_ready & out_6_valid) begin	// @[Arbiter.scala:126:29, CacheCork.scala:127:34, Decoupled.scala:51:35]
      ...
      if (idle & auto_out_a_ready)	// @[Arbiter.scala:89:28, :90:24]
        beatsLeft <= (winnerQual_0 ? ~(_decode_T_1[5:3]) : 3'h0) | (winnerQual_1 & ~(out_1_bits_opcode[2]) ? ~(_decode_T_5[5:3]) : 3'h0);	// @[Arbiter.scala:88:30, :99:79, :112:73, :113:44, CacheCork.scala:73:18, :77:86, :78:27, :93:33, Edges.scala:91:{28,37}, :220:14, Nodes.scala:1215:84, package.scala:235:{46,71,76}]
      ...
      if (idle) begin	// @[Arbiter.scala:89:28]
        state_0 <= winnerQual_0;	// @[Arbiter.scala:117:26, CacheCork.scala:93:33]
        state_1 <= winnerQual_1;	// @[Arbiter.scala:99:79, :117:26]
      end
      if (idle_1 & out_6_ready) begin	// @[Arbiter.scala:89:28, :90:24, CacheCork.scala:127:34]
        if (auto_out_d_valid & out_3_bits_opcode[0])	// @[Arbiter.scala:112:73, CacheCork.scala:153:76, :157:73, :158:27, Edges.scala:105:36, :220:14]
          beatsLeft_1 <= ~(_decode_T_9[5:3]);	// @[Arbiter.scala:88:30, package.scala:235:{46,71,76}]
        else	// @[Arbiter.scala:112:73, Edges.scala:220:14]
          beatsLeft_1 <= 3'h0;	// @[Arbiter.scala:88:30, Nodes.scala:1215:84]
      end
      else	// @[Arbiter.scala:90:24]
        beatsLeft_1 <= beatsLeft_1 - {2'h0, out_6_ready & out_6_valid};	// @[Arbiter.scala:88:30, :114:52, :126:29, CacheCork.scala:127:34, Nodes.scala:1215:84, ReadyValidCancel.scala:49:33]
  ...
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin	// @[CacheCork.scala:107:16]
      ...
      if (~reset & ~(~winnerQual_0 | ~earlyWinner_1)) begin	// @[Arbiter.scala:98:79, :106:{13,61,64,67}, CacheCork.scala:93:33]
      ...
      if (~reset & ~(~_sink_ACancel_earlyValid_T | winnerQual_0 | earlyWinner_1)) begin	// @[Arbiter.scala:98:79, :108:{14,15,36,41}, CacheCork.scala:93:33]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        beatsLeft = _RANDOM_0[19:17];	// @[Arbiter.scala:88:30, Edges.scala:228:27]
        state_0 = _RANDOM_0[20];	// @[Arbiter.scala:117:26, Edges.scala:228:27]
        state_1 = _RANDOM_0[21];	// @[Arbiter.scala:117:26, Edges.scala:228:27]
        beatsLeft_1 = _RANDOM_0[24:22];	// @[Arbiter.scala:88:30, Edges.scala:228:27]
        state_1_0 = _RANDOM_0[25];	// @[Arbiter.scala:117:26, Edges.scala:228:27]
        state_1_1 = _RANDOM_0[26];	// @[Arbiter.scala:117:26, Edges.scala:228:27]
        state_1_2 = _RANDOM_0[27];	// @[Arbiter.scala:117:26, Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_61 q (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
    ...
    .io_deq_ready        (out_6_ready & (idle_1 ? ~auto_out_d_valid : state_1_1)),	// @[Arbiter.scala:17:61, :89:28, :117:26, :122:24, :124:31, CacheCork.scala:127:34]
  ...
  Queue_61 q_1 (	// @[Decoupled.scala:375:21]
    .clock               (clock),
    .reset               (reset),
    ...
    .io_enq_bits_data    (64'h0),	// @[Nodes.scala:1215:84]
    .io_enq_bits_corrupt (1'h0),	// @[Nodes.scala:1215:84]
    .io_deq_ready        (out_6_ready & (idle_1 ? ~_GEN_1 : state_1_2)),	// @[Arbiter.scala:17:61, :89:28, :117:26, :122:24, :124:31, CacheCork.scala:127:34, package.scala:245:43]
  ...
  assign auto_out_a_bits_opcode = muxStateEarly_1 ? out_1_bits_opcode : 3'h0;	// @[Arbiter.scala:118:30, CacheCork.scala:73:18, :77:86, :78:27, Mux.scala:27:73, Nodes.scala:1215:84]
  assign auto_out_a_bits_param = ~muxStateEarly_1 | _T_2 ? 3'h0 : auto_in_a_bits_param;	// @[Arbiter.scala:118:30, CacheCork.scala:77:49, Mux.scala:27:73, Nodes.scala:1215:84]
  ...
  assign auto_out_d_ready = out_6_ready & (idle_1 | state_1_0);	// @[Arbiter.scala:89:28, :117:26, :122:24, :124:31, CacheCork.scala:127:34]
endmodule
