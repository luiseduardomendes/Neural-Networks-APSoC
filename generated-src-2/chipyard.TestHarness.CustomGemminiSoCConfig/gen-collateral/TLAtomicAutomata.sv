  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        beatsLeft = _RANDOM_6[3:1];	// @[Arbiter.scala:88:30, AtomicAutomata.scala:80:24]
        state_0 = _RANDOM_6[4];	// @[Arbiter.scala:117:26, AtomicAutomata.scala:80:24]
        state_1 = _RANDOM_6[5];	// @[Arbiter.scala:117:26, AtomicAutomata.scala:80:24]
