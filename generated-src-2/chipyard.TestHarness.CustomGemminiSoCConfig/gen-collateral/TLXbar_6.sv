...
module TLXbar_6(
  ...
  wire        out_9_bits_corrupt = muxStateEarly_0 & auto_out_0_d_bits_corrupt | muxStateEarly_1 & auto_out_1_d_bits_corrupt;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  wire        out_9_bits_denied = muxStateEarly_0 & auto_out_0_d_bits_denied | muxStateEarly_1 & auto_out_1_d_bits_denied;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  wire        out_9_bits_sink = muxStateEarly_1 & auto_out_1_d_bits_sink;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  wire [4:0]  out_9_bits_source = (muxStateEarly_0 ? auto_out_0_d_bits_source : 5'h0) | (muxStateEarly_1 ? auto_out_1_d_bits_source : 5'h0);	// @[Arbiter.scala:118:30, Bundles.scala:259:74, Mux.scala:27:73]
  ...
  wire [1:0]  out_9_bits_param = muxStateEarly_1 ? auto_out_1_d_bits_param : 2'h0;	// @[Arbiter.scala:118:30, Mux.scala:27:73]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (latch)	// @[Arbiter.scala:90:24]
        beatsLeft <= (winnerQual_0 & auto_out_0_d_bits_opcode[0] ? ~(_beatsDO_decode_T_1[5:3]) : 3'h0) | (winnerQual_1 & auto_out_1_d_bits_opcode[0] ? ~(_beatsDO_decode_T_5[5:3]) : 3'h0);	// @[Arbiter.scala:88:30, :99:79, :112:73, :113:44, Bundles.scala:259:74, Edges.scala:105:36, :220:14, package.scala:235:{46,71,76}]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        beatsLeft = _RANDOM_0[2:0];	// @[Arbiter.scala:88:30]
        readys_mask = _RANDOM_0[4:3];	// @[Arbiter.scala:24:23, :88:30]
        state_0 = _RANDOM_0[5];	// @[Arbiter.scala:88:30, :117:26]
        state_1 = _RANDOM_0[6];	// @[Arbiter.scala:88:30, :117:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign auto_out_1_a_valid = auto_in_a_valid & ~(auto_in_a_bits_address[31]);	// @[Parameters.scala:137:65, Xbar.scala:431:50]
  ...
  assign auto_out_0_a_valid = auto_in_a_valid & auto_in_a_bits_address[31];	// @[Xbar.scala:431:50]
