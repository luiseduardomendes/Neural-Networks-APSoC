...
module Pipeline_10(
  ...
  input  [39:0] io_in_bits_dram_addr,
  input  [67:0] io_in_bits_spad_addr,
  ...
  output [63:0] io_out_bits_cmd_rs1,
                io_out_bits_cmd_rs2,
  output [39:0] io_out_bits_dram_addr,
  output [67:0] io_out_bits_spad_addr,
  ...
  reg  [39:0] stages_0_dram_addr;	// @[Pipeline.scala:21:21]
  ...
  reg  [39:0] stages_1_dram_addr;	// @[Pipeline.scala:21:21]
  ...
  always @(posedge clock) begin
    if (_T_2) begin	// @[Decoupled.scala:51:35]
      ...
      stages_0_cmd_rs2 <= 64'h0;	// @[Pipeline.scala:21:21]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        stages_0_dram_addr = {_RANDOM_8[31:9], _RANDOM_9[16:0]};	// @[Pipeline.scala:21:21]
        stages_0_spad_addr = {_RANDOM_9[31:17], _RANDOM_10, _RANDOM_11[20:0]};	// @[Pipeline.scala:21:21]
        stages_0_I = {_RANDOM_11[31:21], _RANDOM_12[4:0]};	// @[Pipeline.scala:21:21]
        stages_0_J = _RANDOM_12[20:5];	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_funct = _RANDOM_12[27:21];	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_rs2 = {_RANDOM_12[31:28], _RANDOM_13[0]};	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_rs1 = _RANDOM_13[5:1];	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_xd = _RANDOM_13[6];	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_xs1 = _RANDOM_13[7];	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_xs2 = _RANDOM_13[8];	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_rd = _RANDOM_13[13:9];	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_opcode = _RANDOM_13[20:14];	// @[Pipeline.scala:21:21]
        stages_1_cmd_rs1 = {_RANDOM_13[31:21], _RANDOM_14, _RANDOM_15[20:0]};	// @[Pipeline.scala:21:21]
        stages_1_cmd_rs2 = {_RANDOM_15[31:21], _RANDOM_16, _RANDOM_17[20:0]};	// @[Pipeline.scala:21:21]
        stages_1_dram_addr = {_RANDOM_20[31:30], _RANDOM_21, _RANDOM_22[5:0]};	// @[Pipeline.scala:21:21]
        stages_1_spad_addr = {_RANDOM_22[31:6], _RANDOM_23, _RANDOM_24[9:0]};	// @[Pipeline.scala:21:21]
        stages_1_I = _RANDOM_24[25:10];	// @[Pipeline.scala:21:21]
        stages_1_J = {_RANDOM_24[31:26], _RANDOM_25[9:0]};	// @[Pipeline.scala:21:21]
        valids_0 = _RANDOM_25[10];	// @[Pipeline.scala:21:21, :22:25]
        valids_1 = _RANDOM_25[11];	// @[Pipeline.scala:21:21, :22:25]
      `endif // RANDOMIZE_REG_INIT
    end // initial
