...
module SourceC(
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_r_source = _RANDOM_0[18:15];	// @[Reg.scala:19:16, SourceC.scala:58:21]
        req_r_tag = _RANDOM_0[31:19];	// @[Reg.scala:19:16, SourceC.scala:58:21]
        req_r_set = _RANDOM_1[9:0];	// @[Reg.scala:19:16]
        req_r_way = _RANDOM_1[12:10];	// @[Reg.scala:19:16]
        s2_valid = _RANDOM_1[14];	// @[Reg.scala:19:16, SourceC.scala:94:25]
        ...
        s3_valid = _RANDOM_2[24];	// @[Reg.scala:19:16, SourceC.scala:100:25]
  ...
  Queue_55 queue (	// @[SourceC.scala:54:21]
    .clock               (clock),
    .reset               (reset),
    ...
    .io_enq_bits_address ({s3_req_tag[12], 3'h0, s3_req_tag[11:0], s3_req_set, 6'h0}),	// @[Cat.scala:33:92, Parameters.scala:220:15, :228:72, Reg.scala:19:16, SourceC.scala:67:21]
