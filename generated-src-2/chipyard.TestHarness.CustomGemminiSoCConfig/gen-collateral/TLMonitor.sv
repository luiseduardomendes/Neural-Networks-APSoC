...
module TLMonitor(
  ...
  wire [18:0] _a_opcodes_set_T_1 = {15'h0, _T_1208 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {16'h0, io_in_a_bits_source, 2'h0};	// @[Monitor.scala:42:11, :88:31, :638:65, :643:40, :652:{27,72}, :654:{28,53}, :656:54, OneHot.scala:64:12, Parameters.scala:92:42, package.scala:235:71]
  wire [19:0] _a_sizes_set_T_1 = {15'h0, _T_1208 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {16'h0, io_in_a_bits_source, 3'h0};	// @[Bundles.scala:259:74, Monitor.scala:42:11, :88:31, :645:38, :652:{27,72}, :655:{28,51}, :657:52, package.scala:235:71]
  wire        _T_1357 = io_in_d_ready & io_in_d_valid;	// @[Decoupled.scala:51:35]
  wire        _T_1203 = _T_1357 & ~(|d_first_counter);	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:549:20]
  wire        d_clr = _T_1357 & d_first_1 & ~d_release_ack;	// @[Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:670:46, :671:74, :675:72]
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight <= (inflight | _T_1208 & ~io_in_a_bits_source) & ~d_clr;	// @[Monitor.scala:611:27, :623:34, :649:22, :652:{27,72}, :653:28, :675:72, :702:{27,36,38}]
      inflight_opcodes <= (inflight_opcodes | (_T_1208 ? _a_opcodes_set_T_1[3:0] : 4'h0)) & ~{4{d_clr}};	// @[Monitor.scala:613:35, :627:33, :638:65, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:21, :703:{43,60,62}, Parameters.scala:92:42]
      inflight_sizes <= (inflight_sizes | (_T_1208 ? _a_sizes_set_T_1[7:0] : 8'h0)) & ~{8{d_clr}};	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:21, :704:{39,54,56}, :745:35]
    ...
    if (_T_1203) begin	// @[Monitor.scala:549:20]
    ...
    source_1 <= ~_T_1203 & source_1;	// @[Monitor.scala:538:22, :549:{20,32}, :553:15]
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_T_1177 & ~reset & source_1) begin	// @[Monitor.scala:49:11, :538:22, :541:19]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_T_1227 & ~reset & ~(inflight | same_cycle_resp)) begin	// @[Monitor.scala:49:11, :611:27, :680:71, :681:88, :682:49]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_T_1256 & a_first_1 & io_in_a_valid & ~io_in_a_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin	// @[Edges.scala:230:25, Monitor.scala:49:11, :670:46, :671:{26,74}, :694:90, :695:{15,32}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(a_set_wo_ready != (_T_1256 & ~d_release_ack) | ~a_set_wo_ready)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :670:46, :671:{26,71,74}, :699:{29,48,51}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_T_1313 & ~reset) begin	// @[Monitor.scala:49:11, :791:71]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel acknowledged for nothing inflight (connected at SystemBus.scala:41:55)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_T_1313 & ~reset & (|io_in_d_bits_size)) begin	// @[Monitor.scala:49:11, :791:71, :797:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at SystemBus.scala:41:55)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        a_first_counter_1 = _RANDOM_2[30:23];	// @[Edges.scala:228:27, Monitor.scala:537:22]
        d_first_counter_1 = {_RANDOM_2[31], _RANDOM_3[6:0]};	// @[Edges.scala:228:27, Monitor.scala:537:22]
        watchdog = {_RANDOM_3[31:7], _RANDOM_4[6:0]};	// @[Edges.scala:228:27, Monitor.scala:706:27]
        d_first_counter_2 = {_RANDOM_4[31:28], _RANDOM_5[3:0]};	// @[Edges.scala:228:27, Monitor.scala:706:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
