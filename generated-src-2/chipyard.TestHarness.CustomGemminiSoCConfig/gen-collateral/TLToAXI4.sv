...
module TLToAXI4(
  ...
  wire             out_w_bits_last = counter == 3'h1 | (auto_in_a_bits_opcode[2] ? 3'h0 : ~(_beats1_decode_T_1[5:3])) == 3'h0;	// @[Edges.scala:91:37, :220:14, :228:27, :231:{25,37,47}, ToAXI4.scala:176:17, package.scala:235:{46,71,76}]
  ...
  wire             stall = _GEN_0[auto_in_a_bits_source] & a_first;	// @[Edges.scala:230:25, ToAXI4.scala:198:49]
  wire             _out_w_valid_T_3 = doneAW | _queue_arw_deq_io_enq_ready;	// @[Decoupled.scala:375:21, ToAXI4.scala:164:30, :199:52]
  wire             bundleIn_0_a_ready = ~stall & (auto_in_a_bits_opcode[2] ? _queue_arw_deq_io_enq_ready : _out_w_valid_T_3 & _deq_io_enq_ready);	// @[Decoupled.scala:375:21, Edges.scala:91:37, ToAXI4.scala:198:49, :199:{21,28,34,52,70}]
  wire             out_arw_valid = ~stall & auto_in_a_valid & (auto_in_a_bits_opcode[2] | ~doneAW & _deq_io_enq_ready);	// @[Decoupled.scala:375:21, Edges.scala:91:37, ToAXI4.scala:164:30, :198:49, :199:21, :200:{45,51,61,69}]
  ...
  wire [2:0]       bundleIn_0_d_bits_opcode = {2'h0, r_wins};	// @[Edges.scala:231:25, ToAXI4.scala:218:53, :240:23]
  wire [2:0]       bundleIn_0_d_bits_size = r_wins ? auto_out_r_bits_echo_tl_state_size[2:0] : auto_out_b_bits_echo_tl_state_size[2:0];	// @[Edges.scala:758:15, :774:15, ToAXI4.scala:218:53, :240:23]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (bundleIn_0_a_ready & auto_in_a_valid) begin	// @[Decoupled.scala:51:35, ToAXI4.scala:199:28]
        ...
        doneAW <= ~out_w_bits_last;	// @[Edges.scala:231:37, ToAXI4.scala:164:30, :165:38]
      end
      if (x1_r_ready & auto_out_r_valid) begin	// @[Decoupled.scala:51:35, ToAXI4.scala:220:33]
        r_holds_d <= ~auto_out_r_bits_last;	// @[ToAXI4.scala:209:30, :210:42]
    ...
    if (auto_out_b_valid & ~x1_b_ready)	// @[ToAXI4.scala:213:{25,28}, :221:33]
      ...
      b_delay <= 3'h0;	// @[Edges.scala:228:27, ToAXI4.scala:212:24]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        doneAW = _RANDOM_0[3];	// @[Edges.scala:228:27, ToAXI4.scala:164:30]
        r_holds_d = _RANDOM_0[4];	// @[Edges.scala:228:27, ToAXI4.scala:209:30]
        b_delay = _RANDOM_0[7:5];	// @[Edges.scala:228:27, ToAXI4.scala:212:24]
        r_first = _RANDOM_0[8];	// @[Edges.scala:228:27, ToAXI4.scala:227:28]
        r_denied_r = _RANDOM_0[9];	// @[Edges.scala:228:27, Reg.scala:19:16]
        count_1 = _RANDOM_0[10];	// @[Edges.scala:228:27, ToAXI4.scala:257:28]
        count_2 = _RANDOM_0[12];	// @[Edges.scala:228:27, ToAXI4.scala:257:28]
        count_3 = _RANDOM_0[14];	// @[Edges.scala:228:27, ToAXI4.scala:257:28]
        count_4 = _RANDOM_0[16];	// @[Edges.scala:228:27, ToAXI4.scala:257:28]
        count_5 = _RANDOM_0[18];	// @[Edges.scala:228:27, ToAXI4.scala:257:28]
        count_6 = _RANDOM_0[20];	// @[Edges.scala:228:27, ToAXI4.scala:257:28]
        count_7 = _RANDOM_0[22];	// @[Edges.scala:228:27, ToAXI4.scala:257:28]
        count_8 = _RANDOM_0[24];	// @[Edges.scala:228:27, ToAXI4.scala:257:28]
        count_9 = _RANDOM_0[26];	// @[Edges.scala:228:27, ToAXI4.scala:257:28]
        count_10 = _RANDOM_0[28];	// @[Edges.scala:228:27, ToAXI4.scala:257:28]
        count_11 = _RANDOM_0[30];	// @[Edges.scala:228:27, ToAXI4.scala:257:28]
        count_12 = _RANDOM_1[0];	// @[ToAXI4.scala:257:28]
        count_13 = _RANDOM_1[2];	// @[ToAXI4.scala:257:28]
        count_14 = _RANDOM_1[4];	// @[ToAXI4.scala:257:28]
        count_15 = _RANDOM_1[6];	// @[ToAXI4.scala:257:28]
        count_16 = _RANDOM_1[8];	// @[ToAXI4.scala:257:28]
        count_17 = _RANDOM_1[10];	// @[ToAXI4.scala:257:28]
        count_18 = _RANDOM_1[12];	// @[ToAXI4.scala:257:28]
        count_19 = _RANDOM_1[14];	// @[ToAXI4.scala:257:28]
        count_20 = _RANDOM_1[16];	// @[ToAXI4.scala:257:28]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue_51 deq (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
    .io_enq_valid     (~stall & auto_in_a_valid & ~(auto_in_a_bits_opcode[2]) & _out_w_valid_T_3),	// @[Edges.scala:91:{28,37}, ToAXI4.scala:198:49, :199:{21,52}, :202:54]
  ...
  Queue_52 queue_arw_deq (	// @[Decoupled.scala:375:21]
    .clock                            (clock),
    .reset                            (reset),
