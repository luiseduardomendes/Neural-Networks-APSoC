  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        stages_0_spad_addr = {_RANDOM_10[31:13], _RANDOM_11, _RANDOM_12[12:0]};	// @[Pipeline.scala:21:21]
        stages_0_K = _RANDOM_12[28:13];	// @[Pipeline.scala:21:21]
        stages_0_J = {_RANDOM_12[31:29], _RANDOM_13[12:0]};	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_funct = _RANDOM_13[19:13];	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_rs2 = _RANDOM_13[24:20];	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_rs1 = _RANDOM_13[29:25];	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_xd = _RANDOM_13[30];	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_xs1 = _RANDOM_13[31];	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_xs2 = _RANDOM_14[0];	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_rd = _RANDOM_14[5:1];	// @[Pipeline.scala:21:21]
        stages_1_cmd_inst_opcode = _RANDOM_14[12:6];	// @[Pipeline.scala:21:21]
        stages_1_cmd_rs1 = {_RANDOM_14[31:13], _RANDOM_15, _RANDOM_16[12:0]};	// @[Pipeline.scala:21:21]
        stages_1_cmd_rs2 = {_RANDOM_16[31:13], _RANDOM_17, _RANDOM_18[12:0]};	// @[Pipeline.scala:21:21]
        stages_1_dram_addr = {_RANDOM_21[31:22], _RANDOM_22, _RANDOM_23[25:0]};	// @[Pipeline.scala:21:21]
        stages_1_spad_addr = {_RANDOM_23[31:26], _RANDOM_24, _RANDOM_25[25:0]};	// @[Pipeline.scala:21:21]
        stages_1_K = {_RANDOM_25[31:26], _RANDOM_26[9:0]};	// @[Pipeline.scala:21:21]
        stages_1_J = _RANDOM_26[25:10];	// @[Pipeline.scala:21:21]
        valids_0 = _RANDOM_26[26];	// @[Pipeline.scala:21:21, :22:25]
        valids_1 = _RANDOM_26[27];	// @[Pipeline.scala:21:21, :22:25]
      `endif // RANDOMIZE_REG_INIT
    end // initial
