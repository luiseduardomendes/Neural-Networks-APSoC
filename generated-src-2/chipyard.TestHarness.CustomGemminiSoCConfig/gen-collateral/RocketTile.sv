...
module RocketTile(
  ...
  wire         _core_io_ptw_sfence_bits_rs2;	// @[RocketTile.scala:128:20]
  wire [38:0]  _core_io_ptw_sfence_bits_addr;	// @[RocketTile.scala:128:20]
  ...
  wire         _gemmini_io_cmd_ready;	// @[CustomConfigs.scala:63:31]
  wire         _gemmini_io_resp_valid;	// @[CustomConfigs.scala:63:31]
  wire [4:0]   _gemmini_io_resp_bits_rd;	// @[CustomConfigs.scala:63:31]
  wire [63:0]  _gemmini_io_resp_bits_data;	// @[CustomConfigs.scala:63:31]
  wire         _gemmini_io_busy;	// @[CustomConfigs.scala:63:31]
  wire         _gemmini_io_interrupt;	// @[CustomConfigs.scala:63:31]
  wire         _gemmini_io_ptw_0_req_valid;	// @[CustomConfigs.scala:63:31]
  wire [26:0]  _gemmini_io_ptw_0_req_bits_bits_addr;	// @[CustomConfigs.scala:63:31]
  wire         _gemmini_io_ptw_0_req_bits_bits_need_gpa;	// @[CustomConfigs.scala:63:31]
  wire         _gemmini_io_ptw_0_req_bits_bits_vstage1;	// @[CustomConfigs.scala:63:31]
  wire         _gemmini_io_ptw_0_req_bits_bits_stage2;	// @[CustomConfigs.scala:63:31]
  ...
  Gemmini gemmini (	// @[CustomConfigs.scala:63:31]
    .clock                           (clock),
    .reset                           (reset),
  ...
  PTW ptw (	// @[PTW.scala:793:19]
    .clock                                  (clock),
    .reset                                  (reset),
    .io_requestor_0_req_valid               (_gemmini_io_ptw_0_req_valid),	// @[CustomConfigs.scala:63:31]
    .io_requestor_0_req_bits_bits_addr      (_gemmini_io_ptw_0_req_bits_bits_addr),	// @[CustomConfigs.scala:63:31]
    .io_requestor_0_req_bits_bits_need_gpa  (_gemmini_io_ptw_0_req_bits_bits_need_gpa),	// @[CustomConfigs.scala:63:31]
    .io_requestor_0_req_bits_bits_vstage1   (_gemmini_io_ptw_0_req_bits_bits_vstage1),	// @[CustomConfigs.scala:63:31]
    .io_requestor_0_req_bits_bits_stage2    (_gemmini_io_ptw_0_req_bits_bits_stage2),	// @[CustomConfigs.scala:63:31]
    ...
    .io_dpath_sfence_bits_rs2               (_core_io_ptw_sfence_bits_rs2),	// @[RocketTile.scala:128:20]
    .io_dpath_sfence_bits_addr              (_core_io_ptw_sfence_bits_addr),	// @[RocketTile.scala:128:20]
  ...
  RoccCommandRouter cmdRouter (	// @[LazyRoCC.scala:88:27]
    ...
    .io_out_0_ready               (_gemmini_io_cmd_ready),	// @[CustomConfigs.scala:63:31]
  ...
  Queue_102 respArb_io_in_0_q (	// @[Decoupled.scala:375:21]
    .clock            (clock),
    .reset            (reset),
    .io_enq_valid     (_gemmini_io_resp_valid),	// @[CustomConfigs.scala:63:31]
    .io_enq_bits_rd   (_gemmini_io_resp_bits_rd),	// @[CustomConfigs.scala:63:31]
    .io_enq_bits_data (_gemmini_io_resp_bits_data),	// @[CustomConfigs.scala:63:31]
  ...
  Rocket core (	// @[RocketTile.scala:128:20]
    ...
    .io_rocc_busy                               (_cmdRouter_io_busy | _gemmini_io_busy),	// @[CustomConfigs.scala:63:31, LazyRoCC.scala:88:27, RocketTile.scala:171:49]
    .io_rocc_interrupt                          (_gemmini_io_interrupt),	// @[CustomConfigs.scala:63:31]
